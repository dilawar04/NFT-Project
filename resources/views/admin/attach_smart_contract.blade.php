...
<div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Add attach smart contract</h4>
        ...
        ?>
<form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('/admin/attach-smart-contract-add')}}">
       @csrf
       <div class="col-8 d-flex  ">
            <div class="form-group w-50 px-2">
            <label class="form-label" for="customFile">Users</label>
