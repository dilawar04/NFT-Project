  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Add Public Sale</h4>
            <div class="table-responsive">
            <table>
            <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('/admin/store-pub-sale')}}">
       @csrf
       ...
       <div class="col-8 d-flex ">
          ...
          <label for="exampleInputEmail1">White List Users</label>
            <select class="form-control" name="is_whitelisted" required="required">
              <option value="0">Disable</option>
              <option value="1">Enable</option>
            </select>
          </div>
