  ...
  <div id="content" role="main"> 
    ...
    <div class="container pt-5">
      <div class="position-relative d-flex text-center my-5 py-5">
        ...
        <p class="text-9 text-white fw-600 position-absolute w-100 align-self-center lh-base mb-0">Collections<span class="heading-separator-line border-bottom border-3 border-primary d-block mx-auto"></span> </p>
      </div>
    </div>
    <!-- Page Heading end-->
          ...
          <div class="row g-4">
            ...
            <div class="col-sm-6 col-md-3">
              <div class="position-relative bg-dark-2 shadow rounded-4"> <img class="img-fluid d-flex rounded-4 rounded-bottom-0" src="{{$colection->image_preview_url}}" alt="">
                <div class="p-4">
                  <div class="d-flex align-items-center"> <a data-bs-toggle="modal" data-bs-target="#rarity-check-<?=$colection->id?>" href="#" class="overflow-hidden stretched-link me-2">
