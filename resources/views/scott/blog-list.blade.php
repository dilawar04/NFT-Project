...
<!-- Mirrored from harnishdesign.net/demo/html/scott/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Dec 2022 12:29:21 GMT -->
<head>
<meta charset="UTF-8" />
  ...
  <div id="content" role="main"> 
    ...
    <div class="container pt-5">
      <div class="position-relative d-flex text-center my-5 py-5">
        ...
        <p class="text-9 text-white fw-600 position-absolute w-100 align-self-center lh-base mb-0">Blog List<span class="heading-separator-line border-bottom border-3 border-primary d-block mx-auto"></span> </p>
      </div>
    </div>
    <!-- Page Heading end-->
      ...
      <div class="row g-5"> 
        ...
        <div class="col-lg-8 col-xl-9">
          <div class="blog-post blog-post-dark border border-secondary border-opacity-75 shadow rounded-4 p-4 mb-4">
            <div class="row g-0">
              <div class="col-md-5"> <a class="d-flex" href="https://harnishdesign.net/"><img class="img-fluid rounded-4" src="images/blog/post-1.jpg" alt=""></a> </div>
              <div class="col-md-7">
                <div class="card-body pb-0 pt-3 pt-md-0 ps-0 ps-md-4 pe-0">
                  ...
                  <p class="text-2">Some quick example text to build on the card title and make up the bulk of the card's content incididunt.....</p>
                  <a href="https://harnishdesign.net/" class="btn btn-primary btn-sm">Read more</a> </div>
              </div>
            </div>
          </div>
          <div class="blog-post blog-post-dark border border-secondary border-opacity-75 shadow rounded-4 p-4 mb-4">
            <div class="row g-0">
              <div class="col-md-5"> <a class="d-flex" href="https://harnishdesign.net/"><img class="img-fluid rounded-4" src="images/blog/post-2.jpg" alt=""></a> </div>
              <div class="col-md-7">
                <div class="card-body pb-0 pt-3 pt-md-0 ps-0 ps-md-4 pe-0">
          ...
          <div class="blog-post blog-post-dark border border-secondary border-opacity-75 shadow rounded-4 p-4 mb-4">
            <div class="row g-0">
              <div class="col-md-5"> <a class="d-flex" href="https://harnishdesign.net/"><img class="img-fluid rounded-4" src="images/blog/post-3.jpg" alt=""></a> </div>
              <div class="col-md-7">
                <div class="card-body pb-0 pt-3 pt-md-0 ps-0 ps-md-4 pe-0">
          ...
          <div class="blog-post blog-post-dark border border-secondary border-opacity-75 shadow rounded-4 p-4 mb-4">
            <div class="row g-0">
              <div class="col-md-5"> <a class="d-flex" href="https://harnishdesign.net/"><img class="img-fluid rounded-4" src="images/blog/post-4.jpg" alt=""></a> </div>
              <div class="col-md-7">
                <div class="card-body pb-0 pt-3 pt-md-0 ps-0 ps-md-4 pe-0">
